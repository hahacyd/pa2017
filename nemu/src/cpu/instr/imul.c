...
static void instr_execute_2op(){
	...
	opr_dest.val = alu_imul(sign_ext(opr_src.val,opr_src.data_size),sign_ext(opr_dest.val,opr_dest.data_size),data_size);
	operand_write(&opr_dest);
}
make_instr_impl_2op(imul,rm,r,v);
